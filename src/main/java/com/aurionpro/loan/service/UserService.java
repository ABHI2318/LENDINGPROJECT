...
public interface UserService {
	...
	PageResponse<LoanScheme> getAllLoanScheme(int pageSize ,int pageNumber);
	
	LoanResponseDto applyLoan(LoanRequestDto loanRequestDto);
	
	EmiResponseDto emiRepayment(EmiRequestDto emiRequestDto);//Previous Emi Payment records via id
